...
provider boundary {
  ...
  auth_method_id = "ampw_1dOeHaT1wA" # Known issue with the HCP provider, this value isn't computed by the hcp_boundary_cluster resource so it has to be filled in manually https://github.com/hashicorp/terraform-provider-hcp/issues/396
